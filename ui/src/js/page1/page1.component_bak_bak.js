;(function (angular) {
  ...
  angular.module("page1")
       ...
       plotOptions: {
        ...
        series: [{
            name: 'package',
            data: [self.high_data_pre[0].volumes_data.volume_values.DF, self.high_data_pre[0].volumes_data.volume_values.CC,
            self.high_data_pre[0].volumes_data.volume_values.DD,self.high_data_pre[0].volumes_data.volume_values.GC]
        }]
             });
                    });
